...
来自MIT课程线性代数的笔记，可以在[麻省理工公开课：线性代数](http://open.163.com/special/opencourse/daishu.html)观看，官网习题[mit.Linear Algebra](https://ocw.mit.edu/courses/mathematics/18-06-linear-algebra-spring-2010/exams/)。
...
1. [apachecn/mit-18.06-linalg-notes](https://linalg.apachecn.org/#/docs/chapter01)
2. [知乎.MIT线性代数笔记](https://zhuanlan.zhihu.com/p/130694048)
3. [18.06 线性代数（Linear Algebra）中文笔记](https://github.com/ML-NLPChina/MIT-Linear-Algebra-Notes)
